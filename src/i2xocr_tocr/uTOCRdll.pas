...
Type
  ...
  TTOCRJobInfo= Record
    ...
    InputFile                   : PChar;{String;}      // If the JobType requires a file then set this value to the full path and file name for the file. Otherwise it can be ignored.
...
//Function TOCRInitialise       (Var JobNo: LongInt;Var RegNo: LongInt): LongInt;                                                                         StdCall;
Function TOCRInitialise       (Var JobNo: LongInt;Var RegNo: Cardinal): LongInt;                                                      StdCall;
...
Function TOCRGetJobDBInfo     (JobSlotInf: LongInt): LongInt;                                                                        StdCall;
...
Const TOCRDLLName='TOCRRdll.dll'; // DO NOT REMOVE THE .dll, or it will only work on some operating systems !!!
