...
const
  VERSION = 'V 0.9.006';
  APP_NAME = 'DarkWare Image2XML Utility';
  NEW_TEMPLATE = 'Untitled Template';
  REG_KEY = 'Software\Darkware\' + APP_NAME;
  TEMP_DIR_QUAL = 'i2x\';
...
initialization
  ...
  LogFileName := _FileDir.GetSystemTempDir + TEMP_DIR_QUAL + 'Image2XML.log';
  OCRDumpFileName := _FileDir.GetSystemTempDir + TEMP_DIR_QUAL + 'OCRDump.log';
